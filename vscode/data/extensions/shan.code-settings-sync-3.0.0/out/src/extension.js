    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var updateSettings = vscode.commands.registerCommand('extension.updateSettings', function () {
            return __awaiter(this, arguments, void 0, function* () {
                ...
                let ignoredExtensions = new Array();
                                            ...
                                            if (file.gistName == en.FILE_EXTENSION_NAME) {
                                                if (syncSetting.syncExtensions) {
                                                    ...
                                                    if (customSettings.ignoreExtensions && customSettings.ignoreExtensions.length) {
                                                        const extList = pluginService_1.ExtensionInformation.fromJSONList(content);
                                                        const newExtList = extList.filter(extension => !customSettings.ignoreExtensions.includes(extension.name));
                                                        content = JSON.stringify(newExtList);
                                                    }
                                                    if (syncSetting.removeExtensions) {
                                                        try {
                                                            deletedExtensions = yield pluginService_1.PluginService.DeleteExtensions(content, en.ExtensionFolder);
                                                        }
                                                    ...
                                                    try {
                                                        addedExtensions = yield pluginService_1.PluginService.InstallExtensions(content, en.ExtensionFolder, function (message, dispose) {
                                                            //TODO:
                                                            if (dispose) {
        ...
        var otherOptions = vscode.commands.registerCommand('extension.otherOptions', () => __awaiter(this, void 0, void 0, function* () {
            ...
            let items = new Array();
            items.push(localize_1.default("cmd.otherOptions.editLocalSetting"));
            items.push(localize_1.default("cmd.otherOptions.shareSetting"));
            items.push(localize_1.default("cmd.otherOptions.downloadSetting"));
            items.push(localize_1.default("cmd.otherOptions.toggleForceDownload"));
            items.push(localize_1.default("cmd.otherOptions.toggleAutoUpload"));
            items.push(localize_1.default("cmd.otherOptions.toggleAutoDownload"));
            items.push(localize_1.default("cmd.otherOptions.toggleSummaryPage"));
            items.push(localize_1.default("cmd.otherOptions.preserve"));
            items.push(localize_1.default("cmd.otherOptions.joinCommunity"));
            items.push(localize_1.default("cmd.otherOptions.openIssue"));
            items.push(localize_1.default("cmd.otherOptions.releaseNotes"));
            var selectedItem = 0;
            ...
            vscode.window.showQuickPick(items).then((resolve) => __awaiter(this, void 0, void 0, function* () {
                switch (resolve) {
                    ...
                    case items[1]: {
                        //share public gist
                        yield vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.shareSetting.beforeConfirm"), "Yes").then((resolve) => __awaiter(this, void 0, void 0, function* () {
                            if (resolve == "Yes") {
                    ...
                    case items[7]: {
                        ...
                        vscode.window.showInputBox(options).then((res) => __awaiter(this, void 0, void 0, function* () {
                            if (res) {
                                ...
                                if (done) {
                                    if (val == "") {
                                        vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.preserve.info.done1", res));
                                    }
                                    else {
                                        vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.preserve.info.done1", res, val));
                                    }
                                }
                            }
                        }));
                        ...
                        return __awaiter(this, void 0, void 0, function* () {
                            if (added) {
                                switch (selectedItem) {
                                    case 5: {
                                        if (setting.autoDownload) {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.toggleAutoDownload.on"));
                                        }
                                        else {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.toggleAutoDownload.off"));
                                        }
                                        break;
                                    }
                                    case 6: {
                                        if (!setting.quietSync) {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.quietSync.off"));
                                        }
                                        else {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.quietSync.on"));
                                        }
                                        break;
                                    }
                                    case 3: {
                                        if (setting.forceDownload) {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.toggleForceDownload.on"));
                                        }
                                        else {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.toggleForceDownload.off"));
                                        }
                                        break;
                                    }
                                    case 4: {
                                        if (setting.autoUpload) {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.toggleAutoUpload.on"));
                                        }
                                        else {
                                            vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.toggleAutoUpload.off"));
                                        }
                                        break;
                                    }
                                    case 1: {
                                    ...
                                    case 2: {
                                        vscode.window.showInformationMessage(localize_1.default("cmd.otherOptions.warning.tokenNotRequire"));
                                    }
                                }
                            }
                            else {
                                vscode.window.showErrorMessage(localize_1.default("cmd.otherOptions.error.toggleFail"));
                            }
                        });
                    }, function (err) {
